 ...
 * This is the parent of the client-controller package.
 */
function getHostWorkspace(): string {
	// Build output is in client-controller/build/src/
	// Go up to client-controller, then to parent (the host workspace)
 ...
 * Build output is at client-controller/build/src/, so __dirname goes up twice.
 *
