...
// client-controller/scripts → client-controller → vscode-devtools (host workspace root)
...
const inspectorCommand = 'npx @modelcontextprotocol/inspector node client-controller/build/src/index.js';
