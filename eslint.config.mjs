	...
	tseslint.configs.stylistic,
	{
		...
		rules: {
			...
			'no-restricted-syntax': [
				'error',
				{
					message: 'Use process.stdout.write() or process.stderr.write() for standard I/O logging instead of console methods.',
					selector: 'CallExpression[callee.object.name="console"]'
				},
				{
					message: 'for-in loops are banned. Use for-of with Object.keys() or Object.entries() instead.',
		...
		rules: {
			'no-restricted-imports': [
				'error',
				{
					patterns: [
						{
							message: 'Import only the devtools-frontend code exported via node_modules/chrome-devtools-frontend/mcp/mcp.js',
